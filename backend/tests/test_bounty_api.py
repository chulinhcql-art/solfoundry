...
class TestBountySearchAPI:
    ...
    @pytest.mark.asyncio
    async def test_search_bounties_filter_by_reward_range(self, client, sample_bounties):
        """Test filter by reward range."""
        response = await client.get("/api/bounties/search?reward_min=100000&reward_max=300000")
...
class TestBountyGetAPI:
    ...
    async def test_get_bounty_not_found(self, client):
        ...
        response = await client.get("/api/bounties/00000000-0000-0000-0000-000000000000")
